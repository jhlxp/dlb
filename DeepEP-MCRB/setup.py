...
if __name__ == '__main__':
    ...
    num_max_nvl_peers = int(os.getenv('NUM_MAX_NVL_PEERS', '8'))
    assert num_max_nvl_peers in (4, 8), 'NUM_MAX_NVL_PEERS must be 4 or 8'
    ...
    print(f' > NUM_MAX_NVL_PEERS: {num_max_nvl_peers}')
    print()
